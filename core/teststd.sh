...
cecho "### C++ 64-bit" $blue
cecho "#####################################################" $blue
if [ -f "./out/teststd/cpp64/TestingFramework-debug" ]; then
time ./out/teststd/cpp64/TestingFramework-debug
if [ "${?}" -gt "0" ]; then
...
#echo "### C++ 32-bit"
#echo "#####################################################"
#./out/teststd/cpp32/TestingFramework-debug

echo ""
cecho "## JS" $blue
cecho "#####################################################" $blue
if [ $(which node) ]; then
time node out/teststd/js/TestingFramework.js
if [ "${?}" -gt "0" ]; then
...
cecho "#####################################################" $blue
if [ $(which neko) ]; then
time neko out/teststd/neko/TestingFramework.n
if [ "${?}" -gt "0" ]; then
...
cecho "#####################################################" $blue
if [ $(which php) ]; then
time php out/teststd/php/index.php
if [ "${?}" -gt "0" ]; then
