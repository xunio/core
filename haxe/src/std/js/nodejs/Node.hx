...
#if !nodejs
#error  "You could only use this package if you are compile with the nodejs flag"
#end
...
typedef NodeReadStream = { > NodeEventEmitter,
	...
	function read(?size:Int):Null<NodeBuffer>;
...
@:native("js.nodejs.Node.fiber") extern class NodeFiber {
	public static var current : NodeFiber;
	function new(callback : Void -> Void);
	@:overload(function (param : Dynamic) : Void {})
	function run() : Void;
	function reset() : Void;
	function throwInto(exception : Dynamic) : Void;
	@:overload(function (param : Dynamic) : Dynamic {})
	static function yield() : Dynamic;
}
...
class Node {
	...
	public static var fiber(default,null) : Class<NodeFiber>;
...
//	public static var paths:Array<String>;
	...
	public static function wait(seconds : Float) {
	...
	public static function __init__()
{
	...
	untyped __js__("js.nodejs.Node.fiber = js.nodejs.Node.require('fibers')");
